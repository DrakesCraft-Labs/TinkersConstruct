...
/** Represents an item fluid handler for a container with a constant fluid */
public class ConstantFluidContainerWrapper implements IFluidHandlerItem {
  ...
  public FluidStack drain(FluidStack resource, FluidAction action) {
    if (empty || !FluidStack.isSameFluidSameComponents(resource, fluid)) {
