...
/** Variant of BlockStatePropertyCondition that allows using a tag for block type instead of a block */
public class BlockTagLootCondition implements LootItemCondition {
  public static final MapCodec<BlockTagLootCondition> CODEC = RecordCodecBuilder.mapCodec(
    inst -> inst.group(
  ...
  public BlockTagLootCondition(TagKey<Block> tag, Optional<StatePropertiesPredicate> properties) {
    this.tag = tag;
