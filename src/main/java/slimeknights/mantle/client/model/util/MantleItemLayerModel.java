...
/**
 * Reimplementation of {@link ItemLayerModel} to allow:
 * <ul>
 *   <li>Textures higher resolution than 16x16</li>
 *   <li>Quad tinting (via color property)</li>
 *   <li>Emissive surfaces (via luminosity property)</li>
 *   <li>Translucent textures</li>
 * </ul>
 */
public class MantleItemLayerModel implements IUnbakedGeometry<MantleItemLayerModel> {
  ...
  private static void putVertex(VertexConsumer consumer, Direction side, float x, float y, float z, float u, float v, int color, int luminosity) {
    ...
    consumer.setColor((color >> 16) & 0xFF, (color >> 8) & 0xFF, color & 0xFF, (color >> 24) & 0xFF);
